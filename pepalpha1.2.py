...
def wkek(wo_tag, s):
        if "Montag" == wo_tag:
            if "FREI" != Montag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Montag[0][1][:-3]), str(Montag[0][1][2:]))+","+s+","+daytime(int(Montag[0][3][:-3]), str(Montag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Dienstag" == wo_tag:
            if "FREI" != Dienstag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Dienstag[0][1][:-3]), str(Dienstag[0][1][2:]))+","+s+","+daytime(int(Dienstag[0][3][:-3]), str(Dienstag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Mittwoch" == wo_tag:
            if "FREI" != Mittwoch[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Mittwoch[0][1][:-3]), str(Mittwoch[0][1][2:]))+","+s+","+daytime(int(Mittwoch[0][3][:-3]), str(Mittwoch[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Donnerstag" == wo_tag:
            if "FREI" != Donnerstag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Donnerstag[0][1][:-3]), str(Donnerstag[0][1][2:]))+","+s+","+daytime(int(Donnerstag[0][3][:-3]), str(Donnerstag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Freitag" == wo_tag:
            if "FREI" != Freitag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Freitag[0][1][:-3]), str(Freitag[0][1][2:]))+","+s+","+daytime(int(Freitag[0][3][:-3]), str(Freitag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Samstag" == wo_tag:
            if "FREI" != Samstag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Samstag[0][1][:-3]), str(Samstag[0][1][2:]))+","+s+","+daytime(int(Samstag[0][3][:-3]), str(Samstag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
        elif "Sonntag" == wo_tag:
            if "FREI" != Sonntag[0][3]:
                file.write("Dienst"+","+s+","+daytime(int(Sonntag[0][1][:-3]), str(Sonntag[0][1][2:]))+","+s+","+daytime(int(Sonntag[0][3][:-3]), str(Sonntag[0][3][2:]))+",,true,false,,,,CCC"+"\n")
